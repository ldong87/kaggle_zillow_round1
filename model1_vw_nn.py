...
def model_run(tr_x, tr_y, valid_x, valid_y, pid, params):
    ...
    pid = pid.to_frame().assign(f_vwnn=pred)
    return pid
...
#%%
with open('featQ23_vwnn.pkl','wb') as f:
...
#%%
with open('featAll16_vwnn.pkl','wb') as f:
    pk.dump([feat_10, feat_10, feat_10], f, protocol=pk.HIGHEST_PROTOCOL)
    
write_sub([feat_10.f_vwnn.as_matrix(),feat_10.f_vwnn.as_matrix(),feat_10.f_vwnn.as_matrix(),
           feat_10.f_vwnn.as_matrix(),feat_10.f_vwnn.as_matrix(),feat_10.f_vwnn.as_matrix()])
#%%
param = ['-b 6 ' + 
            '--loss_function squared '  + 
            '-l 0.0005 ' + 
...
with open('featQ4567_vwnn.pkl','wb') as f:
...
with open('featAll17_vwnn.pkl','wb') as f:
    pk.dump([feat_22, feat_22, feat_22], f, protocol=pk.HIGHEST_PROTOCOL)
#%%
write_sub([feat_10.f_vwnn.as_matrix(),feat_10.f_vwnn.as_matrix(),feat_10.f_vwnn.as_matrix(),
           feat_22.f_vwnn.as_matrix(),feat_22.f_vwnn.as_matrix(),feat_22.f_vwnn.as_matrix()])
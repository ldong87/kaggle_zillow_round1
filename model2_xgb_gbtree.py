...
def model_run(train, test, params):
    ...
    bst = xgb.train(param, dtrain=xg_train, num_boost_round=iter_max, evals=watchlist, early_stopping_rounds=early_stop, verbose_eval=verbose_iter)
...
#    xgb.plot_importance(bst)
    ...
    print 'baseline: ', np.mean(np.abs(valid_y))
...
#        xgb.plot_importance(bst)
    ...
    pred = bst.predict(xgb.DMatrix(te_x))
    pid = pid.to_frame().assign(f_xgbtree=pred)
...
#%%
write_sub([feat2_10.f_xgbtree.as_matrix(),feat2_11.f_xgbtree.as_matrix(),feat2_12.f_xgbtree.as_matrix(),
           feat2_10.f_xgbtree.as_matrix(),feat2_11.f_xgbtree.as_matrix(),feat2_12.f_xgbtree.as_matrix()])
#%%
# year 2017
...
featQ7L2 = model_run(metaQ23456, metaQ7, params)
metaQ7L2 = featQ7L2.join(train_y.logerror)

with open('xgb_metaQ7L2.pkl','wb') as f:
...
#%%
write_sub([feat2_10.f_xgbtree.as_matrix(),feat2_11.f_xgbtree.as_matrix(),feat2_12.f_xgbtree.as_matrix(),
           feat2_22.f_xgbtree.as_matrix(),feat2_23.f_xgbtree.as_matrix(),feat2_24.f_xgbtree.as_matrix()])
...
#        np.random.seed(0)
    ...
    pid1 = pid.to_frame().assign(f_lgbdt=pred1)
    pid2 = pid.to_frame().assign(f_lgbdt=pred2)
    pid3 = pid.to_frame().assign(f_lgbdt=pred3)
...
#%%
param = {}
param['learning_rate'] = 0.002 # shrinkage_rate
...
param['bagging_fraction'] = 0.75 # sub_row
param['bagging_freq'] = 60
param['num_leaves'] = 500        # num_leaf
param['min_data_in_leaf'] = 100         # min_data_in_leaf
param['verbose'] = 1
param['feature_fraction_seed'] = 2
param['bagging_seed'] = 1
param['tree_learner'] = 'data'
...
#%%
write_sub([feat_10.f_lgbdt.as_matrix(),feat_11.f_lgbdt.as_matrix(),feat_12.f_lgbdt.as_matrix(),
           feat_10.f_lgbdt.as_matrix(),feat_11.f_lgbdt.as_matrix(),feat_12.f_lgbdt.as_matrix()])
#%%    
param = {}
param['learning_rate'] = 0.0015 # shrinkage_rate
param['boosting_type'] = 'gbdt'
...
#%%
write_sub([feat_10.f_lgbdt.as_matrix(),feat_11.f_lgbdt.as_matrix(),feat_12.f_lgbdt.as_matrix(),
           feat_22.f_lgbdt.as_matrix(),feat_23.f_lgbdt.as_matrix(),feat_24.f_lgbdt.as_matrix()])
...
#    lgb.plot_importance(bst)
    ...
    pid = pid.to_frame().assign(f_lgbdart=pred)
    return pid
...
#        te_x3 = data_categ(te_x3)
    ...
    pid1 = pid.to_frame().assign(f_lgbdart=pred1)
    pid2 = pid.to_frame().assign(f_lgbdart=pred2)
    pid3 = pid.to_frame().assign(f_lgbdart=pred3)
...
#%%
param = {}
param['learning_rate'] = 0.0005 # shrinkage_rate
param['boosting_type'] = 'dart'
param['objective'] = 'regression'
param['metric'] = 'l1'          # or 'mae'
param['max_depth'] = 6
...
param['bagging_fraction'] = 0.65 # sub_row
...
#%%   
write_sub([feat_10.f_lgbdart.as_matrix(),feat_11.f_lgbdart.as_matrix(),feat_12.f_lgbdart.as_matrix(),
           feat_10.f_lgbdart.as_matrix(),feat_11.f_lgbdart.as_matrix(),feat_12.f_lgbdart.as_matrix()])
#%%    
param = {}
param['learning_rate'] = 0.0005 # shrinkage_rate
param['boosting_type'] = 'dart'
...
#%%
param = {}
param['learning_rate'] = 0.005 # shrinkage_rate
param['boosting_type'] = 'dart'
param['objective'] = 'regression'
param['metric'] = 'l1'          # or 'mae'
param['max_depth'] = -1
...
#%%
write_sub([feat_10.f_lgbdart.as_matrix(),feat_11.f_lgbdart.as_matrix(),feat_12.f_lgbdart.as_matrix(),
           feat_22.f_lgbdart.as_matrix(),feat_23.f_lgbdart.as_matrix(),feat_24.f_lgbdart.as_matrix()])